...
public class TouchDelegateLayout extends FrameLayout {
	...
	private void init(Context context) {
		...
		LayoutParams lp = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
	 ...
	 * 
	 * This must be done after the view has a size so we know how big to make the Rect,
	 * thus we've chosen to add the delegate in onSizeChanged()
	 */
	@Override
